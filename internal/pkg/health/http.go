...
func Server(pres *ProbeResponder, host string, port uint16, handlers ...Handler) *http.Server {
	...
	for i := range handlers {
		h := handlers[i]
		smux.Handle(h.Path, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
